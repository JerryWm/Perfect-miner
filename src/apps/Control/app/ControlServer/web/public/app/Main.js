define([
	...
	"app/Auth",
	"app/Init",
	"app/GlobalWorkersSummaryHashrate"
], function(
	socketio, 
	Common, 
	Pools, 
	...
	function Main() {
		...
		this.$globalWorkersSummaryHashrate = $('#global-workers-summary-hash-rate-cnt');
		...
		this.gbWSH          = new GlobalWorkersSummaryHashrate(this.$globalWorkersSummaryHashrate, this.socketIo, this);
		...
		$(document).on('click', '[data-popover-focus-model="out-click"]', function(e) {
			var $e = $(e.target);
